...
export default function AiStatusPanel() {
  ...
  return (
    <div className="panel">
      <div className="panel-title">Assistant IA (Groq)</div>
      ...
      {!loading && !configured && (
        <div className="empty-hint" style={{ padding: "10px 0 0" }}>
          Ajoute ta clé gratuite (console.groq.com → API Keys) dans le fichier{" "}
          <code className="mono">.env.local</code> à la racine du projet
          (<code className="mono">GROQ_API_KEY=...</code>), puis redémarre{" "}
